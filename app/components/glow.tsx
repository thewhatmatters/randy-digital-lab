...
// The shared glow ground — Paper's MeshGradient shader
// (@paper-design/shaders-react) seated as a surface's background layer: a
// slow monochrome ink flow (their "Ink" preset recolored to the house
// tokens). Seats: the /work tiles and carousels (showing through the work
// images' transparent margins, so the artwork floats on moving light) and
// the /lab experiment frames (the ground visible around each experiment).
//
...
// an unhovered surface draws no frames. Reduced motion never mounts (the
...
export function Glow({
  ...
  /** The consumer's wake state (hover/focus) — animates only while true. */
  active: boolean
  className?: string
}) {
