...
<Margin label="The 60% rule">
  <LineChart
    label="Agent reliability slips gently from the start, then falls off faster once context passes ~60%"
  ...
  />
  <Caption>It slips from the first tokens — there's no plateau. Past the line the rot just accelerates.</Caption>
</Margin>
