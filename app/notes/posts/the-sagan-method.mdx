...
<SaganLoop
  fig="001"
  caption="The Sagan loop — four stations around one ledger: ticket + AC in, build, critique (with its verify satellite trading evidence), and the promote gate; REVISE arcs back, ESCALATE rays out to a human."
/>
